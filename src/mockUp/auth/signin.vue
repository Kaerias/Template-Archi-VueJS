                ...
                <div class="col-lg-6 d-flex justify-content-center align-items-center">
                    <div class="col-lg-8">
                        ...
                        <div class="description-container">
                            <span><p class="presentation">Bienvenue sur Viticia, la plateforme web de prévision météorologique en temps réel.</p></span>
                        ...
                        <form @submit.prevent="onSubmit">
                            ...
                            <div class="col-lg-12 d-flex justify-content-center not-forget">
                                <div class="checkbox">
                                    <label class="check">
                                        <input type="checkbox" />
                                        Se souvenir de moi
                                ...
                                <div class="pass">
                                    <a href="" class="forgotten-pass">Mot de passse oublié ?</a>
                                </div>
                            </div>
