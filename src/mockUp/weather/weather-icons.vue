<template>
    <div class="col-12">
		...
		c61.8,0,112-50.2,112-112S461.8,64,400,64z"/>
                        ...
                        <p class="weather-block__selected-days">L</p>
                    </div>
                </li>
                <li>
		...
		S444.2,256,400,256z"/>
                        ...
                        <p class="weather-block__days">M</p>
                    </div>
                </li>
                <li>
                    <div class="d-flex flex-column align-items-center">
	...
	c4.1-4.1,10.8-4.1,14.9,0C442.4,392.2,442.4,398.9,438.3,402.9z"/>
                ...
                <li>
                    <div class="d-flex flex-column align-items-center">
                        <svg class="sun-cloud" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink"
                             viewBox="0 0 512 512">
        ...
        c-6.2,6.2-6.2,16.4,0,22.6S326.2,112.4,332.4,106.2z"/>
                        ...
                        <p class="weather-block__days">J</p>
        ...
        c-6.2,6.2-6.2,16.4,0,22.6L131.5,154.2z"/>
                        ...
                        <p class="weather-block__days">V</p>

                    </div>
                </li>
                <li>
                    <div class="d-flex flex-column align-items-center">
                        <svg class="windy-cloud" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink"
                             viewBox="0 0 512 512">
                            <g class="cloud-wrap">
    ...
    c3.1-0.5,6.3-0.7,9.6-0.7c37.3,0,67.6,30.4,67.6,67.7C480,303,449.7,333.3,412.4,333.3z"/>
                        ...
                        <p class="weather-block__days">S</p>
                    </div>
                </li>
                <li>
                    <div class="d-flex flex-column align-items-center">
    ...
    c3.1-0.5,6.3-0.7,9.6-0.7c37.3,0,67.6,30.4,67.6,67.7C480,303,449.7,333.3,412.4,333.3z"/>
                        ...
                        <p class="weather-block__days">D</p>
                    </div>
                </li>
            </ul>
        </div>
